...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-left', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-right', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#form01', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.image.style1', { style: 'zoom-out-image', speed: 1125, intensity: 3, threshold: 3, delay: 0, replay: false });
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Close menu after click a link (mobile UX)
